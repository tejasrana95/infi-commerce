...
export default function EditShippingRulePage() {
  ...
  return (
    <div className={styles.container}>
      <div className={styles.header}><h2>Edit Shipping Rule</h2></div>
      <form onSubmit={handleSubmit} className={styles.form}>
        ...
        <div className={styles.actions}>
          ...
          <button type="submit" className={styles.submitBtn} disabled={loading}>{loading ? 'Updating...' : 'Update Shipping Rule'}</button>
        </div>
      </form>
    </div>
  );
