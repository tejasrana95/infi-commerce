...
export default function EditCustomerPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        setSaving(true);
        try {
            const updateData: any = { ...formData, addresses };
    ...
    const saveAddress = () => {
        ...
        if (addressForm.isDefault) {
            newAddresses.forEach((addr, i) => {
                if (addr.type === addressForm.type && i !== (editingAddressIndex ?? newAddresses.length - 1)) {
            ...
            <form onSubmit={handleSubmit}>
                <Paper sx={{ mb: 3 }}>
                    ...
                    >
                        ...
                        <Tab icon={<LocationOnIcon />} iconPosition="start" label={`Addresses (${addresses.length})`} />
                    </Tabs>
