...
export const AVAILABLE_MODULES: ModuleDefinition[] = [
    ...
    },
    {
        ...
        icon: 'Extension',
        category: 'standard',
        description: 'Compact horizontal feature strip with icons',
        defaultConfig: {
            borderColor: '#e8d8bd',
            ...
            textAlign: 'left',
            items: [
                { id: 'delivery', icon: 'FaShippingFast', title: 'Worldwide Delivery', description: 'Shipping to 50+ Countries', link: '', openInNewTab: false },
                { id: 'packaging', icon: 'FaBoxOpen', title: 'Secure Packaging', description: '100% Safe & Damage Free', link: '', openInNewTab: false },
                { id: 'quality', icon: 'FaRegStar', title: 'Quality Assurance', description: 'Premium Makrana Marble', link: '', openInNewTab: false },
                { id: 'support', icon: 'FaHeadset', title: '24/7 Support', description: "We're here to help you", link: '', openInNewTab: false },
            ],
        },
    },
    {
        ...
        category: 'standard',
        description: 'List of features, items or steps with icons',
        defaultConfig: {
            direction: 'vertical',
            iconColor: '#3b82f6',
            titleColor: '#1f2937',
            ...
            borderColor: '#e5e7eb',
            items: [
                { id: 'item-1', icon: 'FaCheck', title: 'Premium Quality', description: 'Handpicked and verified materials', link: '', openInNewTab: false },
                { id: 'item-2', icon: 'FaCheck', title: 'Fast shipping', description: 'Delivered directly to your doorstep', link: '', openInNewTab: false },
                { id: 'item-3', icon: 'FaCheck', title: 'Secure payments', description: 'SSL protected checkout process', link: '', openInNewTab: false },
            ],
        },
    },
    {
    ...
    },
    {
        ...
        icon: 'EmojiEmotions',
        category: 'standard',
        description: 'Display a single styled icon',
        defaultConfig: {
            icon: 'FaStar',
            size: 48,
            iconColor: '#000000',
    ...
    },
    {
        ...
        icon: 'TableChart',
        category: 'standard',
        description: 'Data table with customizable styling',
        defaultConfig: {
