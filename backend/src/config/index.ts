...
export const config = {
    ...
    aws: {
        ...
        s3Bucket: process.env.AWS_S3_BUCKET || process.env.AWS_BUCKET_NAME || 'infi-commerce-uploads',
        endpoint: process.env.S3_ENDPOINT || process.env.AWS_ENDPOINT_URL || '',
        publicUrl: process.env.S3_PUBLIC_URL || process.env.AWS_CLOUDFRONT_URL || '',
